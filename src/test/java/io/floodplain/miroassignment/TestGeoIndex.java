...
public class TestGeoIndex {
    ...
    public void testEasyWithGaps() {
        widgetService.insertWidget(Widget.create(10,10,10,10));
        widgetService.insertWidget(Widget.create(30,10,10,10));
        widgetService.insertWidget(Widget.create(50,10,10,10));
        ...
        widgetService.insertWidget(Widget.create(15,10,10,10));
        // test overlap
